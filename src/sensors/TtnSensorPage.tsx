...
// ✅ Helper to get status color safely (handles "1" or 1)
            ...
            >
                ...
                >
                    ...
                    <TextField
                        ...
                        size="small"
                        fullWidth
                        InputProps={{ style: { backgroundColor: "#eee", color: "#000" } }}
            ...
            {connected && (
                <div style={{ textAlign: "center", marginBottom: "20px" }}>
                    <Button
                        ...
                        style={{ fontWeight: "bold", color: "#333", borderColor: "#333" }}
                    >
                        Connect TTN App
                    </Button>
                    <Button
                        ...
                        style={{ fontWeight: "bold", color: "#333", borderColor: "#333", marginLeft: "10px" }}
                    >
                        Disconnect
                    </Button>
                </div>
